...
public class PlayerAvaterManager extends JDialog {
	...
	private static final long serialVersionUID = 2362050237753363005L;
	...
	public PlayerAvaterManager(Window owner,  URL url,
			int id) {
	...
	private String getExternalFileName() {
		FileDialog fileChooser = new FileDialog(this, "Select Avater",
				FileDialog.LOAD);
		...
		if (fileChooser.getFile() != null) {
			...
			if (fn.endsWith(".jpg") || fn.endsWith(".jpeg")
				...
				externalAbsolutePath = fileChooser.getDirectory()
						+ fileChooser.getFile();
			else {
				return null;
			}
